...
namespace UniversityCodeFirst.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        {
            var people = db.Instructors.Include(i => i.OfficeAssignment);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonID,LastName,FirstMidName,HireDate")] Instructor instructor)
        {
            if (ModelState.IsValid)
            {
